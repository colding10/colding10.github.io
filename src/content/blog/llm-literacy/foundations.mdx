...
<Aside>
This is the CliffsNotes version. If you already know about bag-of-words and RNNs, skip to [Tokens](#tokens). If you don't, you're not missing much; the pre-transformer era is mostly useful as background for why transformers mattered so much.
</Aside>
