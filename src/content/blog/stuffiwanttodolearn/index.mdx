...
afl / libfuzzer are rlly cool and i want to learn. want to try out vuln research and fuzz some stuff.

### [Angr](https://angr.io)

there are a lot of rev CTF challenges that can be easily done with symbolic exeuction and i kinda know it but not well enough

## Stuff I want to do

### travel somewhere for an inperson CTF

like every single ctf i do is online or travelling within state (that one time), id be cool to go somewhere
