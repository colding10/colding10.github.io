...
*by the way, there is no rev writeup. go check out [dudcom's writeup](https://spl.team) once he writes it. the rev tag is cuz in this foren chall i had to do a little bit of rev*.
