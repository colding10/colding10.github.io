...
description: 'cheesing a crypto with a timing side-channel'
date: 2025-11-18
...
| Rank | Team | Points |
|------|------|--------|
| **1** | **Cosmic Bit Flip** | **3994** |
| 2 | 0xf1sh | 3255 |
| 3 | tjcsc | 3121 |
| 4 | coderdojotm | 1127 |
| 5 | Dead Pirate Society | 673 |

More thanks to [les amateurs](https://amateurs.team) for organizing a great CTF with high quality challenges. 

Here I'll write about two crypto challenges that wjat and I solved using a timing side-channel. *This writeup won a writeup award*.

- **crypto/addition 2** &mdash; 309 pts, solved 11/17/2025 at 11:17 PM
- **crypto/addition 3** &mdash; 430 pts, solved 11/18/2025 at 4:07 PM

## What the server did

```python title=addition2.py
...
```python title=addition3.py {"n is now regenerated each time":11-12} {"lshift 512 instead of 256":7-8}
from Crypto.Util.number import *
import os
from random import getrandbits, choice
import hashlib
